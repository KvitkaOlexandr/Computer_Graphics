...
public class SnowMan extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Buttons
        Ellipse b1 = new Ellipse(X(45), Y(16), 2, 2);
        b1.setStroke(Color.BLACK);
        b1.setStrokeWidth(4);
        root.getChildren().add(b1);
        Ellipse b2 = new Ellipse(X(50), Y(28), 2, 2);
        b2.setStroke(Color.BLACK);
        b2.setStrokeWidth(4);
        root.getChildren().add(b2);
        Ellipse b3 = new Ellipse(X(43), Y(40), 2, 2);
        ...
        left_hand.setFill(Color.rgb(115, 76, 40));
        ...
        QuadCurveTo qc10 = new QuadCurveTo(X(150), Y(-20), X(109), Y(-11));
        ...
        right_hand.setFill(Color.rgb(115, 76, 40));
        ...
        // Oral cavity
        Arc mouthArc = new Arc(X(26), Y(-19), 10, 4, 100, 230);
        mouthArc.setStrokeWidth(1);
        mouthArc.setStroke(Color.BLACK);
        mouthArc.setFill(Color.BLACK);
